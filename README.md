...
Phases 0–4 complete (foundation, database schema, authentication, market dashboard with live
prices, order entry). See `docs/decisions.md` for the running decision log and the project
